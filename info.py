...
BOT_TOKEN = environ.get('BOT_TOKEN', "5581244188:AAETzdpnqWsSQO11XNqDsS7gzvRbPcP7MVU")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sachin12:Sachin12@cluster0.qpdpdfj.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/bots_supported')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/sm_movies_1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/SM_Movies_Request')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -1001895586483))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL',  -1001895586483))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/bots_supported')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/bots_supported/30')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001148047176))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001148047176))
